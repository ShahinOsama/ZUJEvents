...
if (empty($emailErr) && empty($passwordErr)) {
    ...
    $stmt = mysqli_prepare($connect, "SELECT Admin_id, name FROM admin WHERE email = ? AND password = ?");
    ...
    if (mysqli_stmt_num_rows($stmt) == 1) {
        ...
        $_SESSION["name"] = $name;
        header("location: eventsReview.php");
        exit;
    } else {
...
body
{
  background-image: url('photo/loginB.png');  
...
<form class="loginform" method="post" action="#" style="margin-bottom:50px;"> 
  ...
  <div class="register"><a class="register-font" href="adminregister.php">SignUp?</a></div>
</div>
</form>
     </div>
